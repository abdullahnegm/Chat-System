...
class ApplicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create application" do
    assert_difference('Application.count') do
      post applications_url, params: { application: { identifier: @application.identifier, name: @application.name } }
    end
  ...
  test "should update application" do
    patch application_url(@application), params: { application: { identifier: @application.identifier, name: @application.name } }
